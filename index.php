			...
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<h1><a href="index.php">Jiro Lin</a></h1>
						<nav id="nav">
							<ul>
								<li class="special">
				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							<h2>Jiro Lin</h2>
							<p>Make Something People Want<br />
							With Great Team<br />
							To the Whole <a href="http://html5up.net">World</a>.</p>
							<ul class="actions">
								<li><a href="#" class="button special">See Videos</a></li>
							</ul>
						</div>
									...
									<div class="row uniform">
										...
										<div class="12u$">
											<ul class="actions">
												...
												<li><input type="reset" value="Reset" class="special2"/></li>
											</ul>
										</div>
									</div>
								</form>
